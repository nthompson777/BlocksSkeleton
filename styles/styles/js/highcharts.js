...
(function() {
    ...
    E = {
        colors: "#3A7FC2, #66BB52, #643F98, #66b3ff, #97D252, #a476e4, #c28f3a, #336e25, #174775, #9CC692, #8D79A9, #7AA4CC".split(","),
        // original (PRE 08.04.15) color set from dev:  #3A7FC2', '#66BB52', '#643F98', '#48ADE2', '#9453A0', '#e4d354', '#BDD747', '#8d4653', '#91e8e1
    ...
    ta.prototype = {
        ...
        getStyle: function(a) {
            return this.style = r({
                fontFamily: '"robotoregular", "Helvetica", Arial, Helvetica, sans-serif',
                fontSize: "12px",
            }, a)
        },
        isHidden: function() {
...
/*
 Highcharts-3D JS v4.0.4 (2014-09-02)
